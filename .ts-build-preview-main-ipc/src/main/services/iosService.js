...
exports.createIosService = createIosService;
const iosBackupRuntimeUtils_js_1 = __importDefault(require("./iosBackupRuntimeUtils.js"));
const iosPairing_js_1 = require("./iosPairing.js");
const iosBackupCache_js_1 = require("./iosBackupCache.js");
const iosBackupProgress_js_1 = require("./iosBackupProgress.js");
const iosMvtParser_js_1 = require("./iosMvtParser.js");
const iosMvtExecution_js_1 = require("./iosMvtExecution.js");
const { safeEmit, formatBytes, getDirectoryStats, removeDirectorySafe, estimateTotalFromGrowth, parseBackupProgressLine, clampPercent, randomIntInclusive, normalizeIosProgressPolicy, spawnWithLineStream } = iosBackupRuntimeUtils_js_1.default;
...
function createIosService({ fs, path, os, log, CONFIG, Utils }) {
    ...
    const iosPairing = iosPairing_js_1.createIosPairingHelpers({ fs, CONFIG, Utils });
    const iosBackupCache = iosBackupCache_js_1.createIosBackupCacheHelpers({
        fs,
        path,
        getDirectoryStats,
        removeDirectorySafe,
    ...
    const iosBackupProgress = iosBackupProgress_js_1.createIosBackupProgressHelpers({
        fs,
        path,
        Utils,
        formatBytes,
    ...
    const iosMvtParser = iosMvtParser_js_1.createIosMvtParser({
        fs,
        path,
        Utils
    });
    const iosMvtExecution = iosMvtExecution_js_1.createIosMvtExecutionHelpers({
        fs,
        path,
        Utils,
        getDirectoryStats,
