...
const previewBase = path.join(rootDir, '.ts-build-preview', 'src', 'main', 'testing');
const runtimeBase = path.join(rootDir, 'src', 'main', 'testing');

const targets = ['mockData.js'];
...
console.log('[DONE] main testing wave synced');
