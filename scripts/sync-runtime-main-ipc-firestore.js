...
const previewBase = path.join(rootDir, '.ts-build-preview-main-ipc', 'src', 'main', 'ipc');
const runtimeBase = path.join(rootDir, 'src', 'main', 'ipc');

const targets = ['firestoreHandlers.js'];
...
console.log('[DONE] main ipc firestore synced');
