...
exports.createAndroidService = createAndroidService;
const riskRules_js_1 = __importDefault(require("../../shared/constants/riskRules.js"));
const spywareFinalFilter_js_1 = __importDefault(require("../../shared/constants/spywareFinalFilter.js"));
const androidDeviceSecurity_js_1 = require("./androidDeviceSecurity.js");
const androidAppInventory_js_1 = require("./androidAppInventory.js");
const androidScanAnalysis_js_1 = require("./androidScanAnalysis.js");
const androidScanPreparation_js_1 = require("./androidScanPreparation.js");
function createAndroidService({ client, adb, ApkReader, fs, path, os, crypto, log, exec, CONFIG, Utils, analyzeAppWithStaticModel }) {
    ...
    const { evaluateAndroidAppRisk, RISK_LEVELS } = riskRules_js_1.default;
    const { evaluateAndroidSpywareFinalVerdict } = spywareFinalFilter_js_1.default;
    ...
    const androidDeviceSecurity = androidDeviceSecurity_js_1.createAndroidDeviceSecurityHelpers({
        client,
        adbShell,
        adbShellWithTimeout
    });
    const androidAppInventory = androidAppInventory_js_1.createAndroidAppInventoryHelpers({
        client,
        adb,
        ApkReader,
        fs,
    ...
    const androidScanAnalysis = androidScanAnalysis_js_1.createAndroidScanAnalysisHelpers({
    ...
    const service = {};
    const androidScanPreparation = androidScanPreparation_js_1.createAndroidScanPreparationHelpers({
