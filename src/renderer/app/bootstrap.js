...
/** @typedef {import('../../types/renderer-context.d.ts').RendererContext} RendererContext */
/** @typedef {import('../../types/renderer-context.d.ts').RendererState} RendererState */
/** @typedef {import('../../types/renderer-context.d.ts').AuthService} AuthService */
/** @typedef {import('../../types/renderer-context.d.ts').FirestoreService} FirestoreService */
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    /**
     * @param {{ ViewManager: RendererContext['ViewManager'], loggedOutView: HTMLElement | null }} deps
     */
