        ...
        const ScanController = {
            ...
            async startAndroidScan() {
                ...
                this.resetSmartphoneUI();
	                ...
	                // Live dashboard polling (Android)
            ...
            _renderAndroidDashboard({ metrics, spec, top }) {
                ...
                if (metrics) {
                    ...
                    if (status) {
                        ...
                        status.textContent = isConnected ? '● SECURE CONNECTION' : '● DISCONNECTED';
            ...
            finishScan(data) {
                ...
                // NOTE: Android dashboard is intended to keep updating even after scan completion.
