...
export function createScanControllerMethods({ scanDeviceRuntime, scanStartUi, androidScanRunner, scanLogSession, scanLogQuota, iosScanProgress, iosScanRunner, scanLifecycle, bdResetAndroidDashboardUI, IOS_TRUST_PROMPT_MESSAGE }) {
