// Synced from TypeScript preview output. Source of truth: userSettingsService.ts
...
function getAuth(servicesOrFirebase) {
    return servicesOrFirebase?.auth ?? servicesOrFirebase ?? null;
}
...
export async function fetchUserInfoAndSettings(servicesOrFirebase, _constants, uidOverride) {
