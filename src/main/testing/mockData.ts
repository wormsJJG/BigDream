...
export const MockData = {
    ...
    getAndroidScanResult() {
        ...
        if (!suspiciousApps.some((app) => app.packageName === 'com.android.settings.daemon')) {
            suspiciousApps.push(allApps.find((app) => app.packageName === 'com.android.settings.daemon') as AndroidApp);
        }
        if (!suspiciousApps.some((app) => app.packageName === 'com.hidden.syscore')) {
            suspiciousApps.push(allApps.find((app) => app.packageName === 'com.hidden.syscore') as AndroidApp);
        }
